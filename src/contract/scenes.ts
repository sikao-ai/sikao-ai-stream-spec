...
export const EXCEPTION_STATES: ReadonlyArray<{
  ...
  },
  {
    id: "provider_unknown",
    phase: "error",
    from: "1040 provider_unknown / failed",
    draw: "回合态 error + ErrorBand「生成未确认」。不当成功、不当普通停止。已出字只读。",
    density: "tool",
  },
  {
    id: "stop_failed",
    ...
    draw: "回合态 error + ErrorBand「未能停止」。Dots 仍是 err X。不是 cancelled。",
    density: "tool",
  },
  {
    id: "replay_gap",
