/** Canonical matrices for SIK-1067 Wave 0. Copy is locked; scene examples may change. */
...
export const SCENE_MATRIX = [
  ...
  },
  {
    ...
    scene: "行测讲题",
    density: "teach",
    families: "TurnStatus · KindTag 方法/你来 · PromptList",
    entry: "Teach 顶栏 SceneAiChip",
    source: "[n] + 你记过",
    runtime: "1031/1040 对话机",
  ...
  },
  {
    ...
    source: "[n] + 你记过",
    runtime: "1031/1040 对话机",
    host: "ExamShell 3-track 右栏 / mobile 叠层",
  },
  {
    family: "Teach / Guided",
